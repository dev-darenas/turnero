    ...
    <body>
        ...
        <%
            ...
            try{ 
                ...
                rs=st.executeQuery("select * from producto where id= "+ id_producto +"");
                rs.next();
             }catch(Exception e){}
        %>
        <div class="container">
		...
		<div class="wrap-contact100">
                     <form class="contact100-form validate-form" action="/turnero/EditarProducto" method="post">
                        <span class="contact100-form-title">
                            Editar Producto
                        </span>
                        <input type="hidden" name="id" value="<%= rs.getString("id") %>">
                        <input class="input100" type="hidden" name="id_producto" placeholder="id_producto" value="<%= rs.getInt(1) %>">
                        ...
                        <div class="wrap-input100 bg1 rs1-wrap-input100">
                            ...
                            <div class="pretty p-switch">
                                <input name="es" type="checkbox" value="1" 
                                       <% if(rs.getString("estado").equalsIgnoreCase("1")){ %>
                                        checked
                                       <% } %>
                                       />
                                <div class="state">
