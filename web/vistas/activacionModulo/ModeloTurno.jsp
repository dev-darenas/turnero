...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <hr>  
            <div class="row">  
                <form method="POST" action="/turnero/llamarTurno" class="col-md-3">
                    ...
                    <input name="perfil" type="hidden" value="<%= request.getParameter("nombre")%>"> 
                    <input name="llamar" type ="submit" value ="Llamar turno" class="btn btn-primary">
                </form>
                ...
                <form method="POST" action="/turnero/ControlBot" style="position:absolute; left: 7%;margin-top: 140px">
                    <div class="wrap-input100 bg1 rs1-wrap-input100" style="width: 300px">
                        <span class="label-input100">Conectar Cuenta a Modulo</span>
                        <input name="perfil" type="text" class="input100" id="conectar" value="<%= request.getParameter("nombre")%>" placeholder="Nombre del modulo" />  
                        <input name="conectar" type="submit" value="Conectar Cuenta Whatsapp" class="" id="conectar"/>                       
                    </div>
                </form>
