...
public class GenerarTurno extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String turno = co.crearTurno(cedula, celular, correo, tipoServicio, prioridad, notwhatsapp, notemail, notsms);
            if (!turno.equals("")) {
                response.sendRedirect("/turnero/vistas/turno/generar.jsp?turno="+turno);
            } else {
                response.sendRedirect("/turnero/vistas/turno/generar.jsp?error=true");
            }
